<template>
    <b-form @submit="onSubmit">
          ...
          <b-form-group
            ...
            label="Jira"
          >
            <b-form-input id="jira"  title="tool.compatibilite.Jira" v-model.trim="tool.compatibilite.Jira"></b-form-input>
          </b-form-group>
          <b-form-group
            id="fieldsetHorizontal"
            horizontal
            ...
            label="Xray"
          >
            <b-form-input id="xray"  title="tool.compatibilite.Xray" v-model.trim="tool.compatibilite.Xray"></b-form-input>
          </b-form-group>
          <b-form-group
            id="fieldsetHorizontal"
            horizontal
            ...
            label="Github"
          >
            <b-form-input id="github" title="tool.compatibilite.Github" v-model.trim="tool.compatibilite.Github"></b-form-input>
          </b-form-group>
          <b-form-group
            id="fieldsetHorizontal"
            horizontal
            ...
            label="Url"
          >
            <b-form-input id="url" title="too.url" v-model.trim="tool.url"></b-form-input>
          </b-form-group>
          <b-form-group
            id="fieldsetHorizontal"
            horizontal
            ...
            label="logo"
          >
            <b-form-input id="logo" title="tool.logo" v-model.trim="tool.logo"></b-form-input>
          </b-form-group>
          <b-form-group
            id="fieldsetHorizontal"
            horizontal
